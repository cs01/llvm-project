...
// isBlockPointerType() gate and no block-invoke handler in NullabilitySafety.cpp,
...
//
// RUN: %clang_cc1 -fsyntax-only -fblocks -fnullability-safety -fnullability-default=nullable -Wno-unused-value %s -verify
