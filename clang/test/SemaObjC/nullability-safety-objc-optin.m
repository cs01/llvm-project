...
//
// With -fnullability-safety on but no -fnullability-default and no
...
//
// RUN: %clang_cc1 -fsyntax-only -fblocks -fobjc-arc -fnullability-safety -Wno-objc-root-class -Wno-unused-value %s -verify
