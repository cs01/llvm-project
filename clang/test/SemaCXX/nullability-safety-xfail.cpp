...
// nullability-safety-checker-gaps.cpp for the same pattern.
//
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++20 -fcxx-exceptions -Wno-unused-value %s -verify
