// nullability-safety-nonnull-assign.cpp - Tests for assigning null to _Nonnull.
//
// Covers: field default init, member assignment, local variable assignment,
// and dereference after null assignment to _Nonnull.
//
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nonnull %s -verify
