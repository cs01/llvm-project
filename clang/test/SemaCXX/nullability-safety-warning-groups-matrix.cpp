// On/off matrix for the five -Wnullability-safety-* subgroups.
//
// nullability-safety-warning-groups.cpp only exercises the dereference subgroup.
...
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value %s -verify=default
//
// Each -Wno-nullability-safety-SUB silences ONLY its own subgroup:
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nullability-safety-dereference %s -verify=noderef
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nullability-safety-arithmetic %s -verify=noarith
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nullability-safety-return %s -verify=noret
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nullability-safety-assignment %s -verify=noassign
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nullability-safety-argument %s -verify=noarg
//
// The parent group silences all five:
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Wno-nullability-safety %s -verify=noparent
//
// Each -Werror=nullability-safety-SUB promotes ONLY its own subgroup to an error,
// leaving the other four as warnings:
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Werror=nullability-safety-dereference %s -verify=wederef
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Werror=nullability-safety-arithmetic %s -verify=wearith
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Werror=nullability-safety-return %s -verify=weret
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Werror=nullability-safety-assignment %s -verify=weassign
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++17 -Wno-unused-value -Werror=nullability-safety-argument %s -verify=wearg
