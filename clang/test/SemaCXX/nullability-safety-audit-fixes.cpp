// nullability-safety-audit-fixes.cpp - Tests for audit-identified bugs.
//
...
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -std=c++20 %s -verify
