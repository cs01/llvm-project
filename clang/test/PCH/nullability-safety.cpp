...
// (-fnullability-safety, -fnullability-default=nullable) must survive
...
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -include %S/nullability-safety.h -verify %s
...
// RUN: %clang_cc1 -fsyntax-only -fnullability-safety -fnullability-default=nullable -include-pch %t -verify %s
